...
describe('Message e2e test', () => {
  ...
  describe('Message page', () => {
    ...
    describe('with existing value', () => {
      ...
      it.skip('edit button click should load edit Message page and save', () => {
        cy.get(entityEditButtonSelector).first().click();
        cy.getEntityCreateUpdateHeading('Message');
  ...
  describe('new Message page', () => {
    ...
    it('should create an instance of Message', () => {
      cy.get(`[data-cy="senderId"]`).type('91576').should('have.value', '91576');

      cy.get(`[data-cy="recieverId"]`).type('80378').should('have.value', '80378');

      cy.get(`[data-cy="content"]`).type('Spring Granite').should('have.value', 'Spring Granite');

      cy.get(`[data-cy="timestamp"]`).type('2023-04-30T03:05').blur().should('have.value', '2023-04-30T03:05');
