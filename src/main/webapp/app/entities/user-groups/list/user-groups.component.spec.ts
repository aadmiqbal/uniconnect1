...
describe('UserGroups Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'user-groups', component: UserGroupsComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to userGroupsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getUserGroupsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getUserGroupsIdentifier).toHaveBeenCalledWith(entity);
