...
describe('AppUsers Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'app-users', component: AppUsersComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to appUsersService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getAppUsersIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getAppUsersIdentifier).toHaveBeenCalledWith(entity);
